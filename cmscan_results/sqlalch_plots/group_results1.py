...
plotly.offline.plot(fig, filename = './files/1_ursgroup.html')
...
plotly.offline.plot(fig, filename='./files/allrnatypes')


#SIG
trace1 = Bar(
        x=sig_rnatype_table.index, # assign x as the dataframe column 'x'
...
fig = go.Figure(data=data, layout=layout)
plotly.offline.plot(fig, filename='./files/sig_rnatypes.html')
